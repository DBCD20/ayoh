...
class Footer extends Component {
    render(){
        return(
            <footer className='container-fluid d-flex align-items-center p-4' style={{borderTop: '20px solid #60CAAD', background: 'linear-gradient(to right, #6441A5 0%, #2a0845 100%)', flexFlow: 'row wrap'}}>
                ...
                <p className='text-white pt-4' style={{flex: '100% 1 2', fontSize: '0.8rem'}}>
